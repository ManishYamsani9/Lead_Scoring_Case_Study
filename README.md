...
- Precision- Recall
## File Details
  - LeadScoring_CaseStudy.ipynb - Python file shows code
  - Lead Scoring Questions & Answers.docx - Subjective Questions and Answers
  - Lead Scoring Presentation.pdf  - Final Presentation on case Study
  - Lead Scoring Summary.pdf - Summary on the Case Study
